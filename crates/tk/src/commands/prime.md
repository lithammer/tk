...
- Use `tk sync log` to list unresolved and curated Mutations — every state except applied; `tk sync log <sequence>` inspects any single Mutation, applied included.
