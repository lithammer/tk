...
mod tests {
    ...
    fn repeated_bindings_keep_ordered_history_without_constraining_the_remote() {
        ...
        detach_item(&store, &cwd_path, "gh-42");
        let mut promote_h = Harness::new(&cwd_path, &store);
        ...
        let mut clear_h = Harness::new(&cwd_path, &store);
        ...
        let mut set_h = Harness::new(&cwd_path, &store);
        ...
        let mut list_h = Harness::new(&cwd_path, &store);
        ...
        let mut next_h = Harness::new(&cwd_path, &store);
        ...
        let mut search_h = Harness::new(&cwd_path, &store);
