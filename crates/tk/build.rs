...
//! to appear as whole tokens in stdout. Per ADR-0030 the release pipeline is
...
//! `Cargo.toml` placeholder (`0.0.0`, never bumped — ADR-0030) and the triple
...
fn main() {
    ...
    // The release version rides the git tag (ADR-0030); `CARGO_PKG_VERSION` is
